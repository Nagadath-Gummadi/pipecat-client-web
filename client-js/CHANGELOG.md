...
## [1.12.0](https://github.com/Nagadath-Gummadi/pipecat-client-web/compare/client-js-v1.13.1...client-js-v1.12.0) (2026-09-05)
...
* **js:** accept DTMF key sequences in sendDTMF ([5c5ce54](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/5c5ce54f74a7f5426ab7df868704e70996941aac))
* **js:** add MediaState lifecycle on PipecatClient ([09cf915](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/09cf915db7138b54e56c6145258b7f797b72c3a8))
* **js:** add MediaState lifecycle on PipecatClient ([793e162](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/793e1625efe40ea6e37199e6212f978810caa93b))
* **js:** add sendDTMF method and DTMFButton type ([47ad59a](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/47ad59a6ce9b36524a12907eaee1214897a5a2d2))
* **js:** add support for bot-output-progress events ([34078b9](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/34078b948e35243be283fce41685dc0dcc31f3c1))
* **js:** bump RTVI protocol version to 1.4.0 ([b353c0e](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/b353c0e687ce91d5af031373c6b51fa576d52411))
* **js:** bump RTVI protocol version to 1.4.0 ([e5d2568](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/e5d256815eb69c5bef76d3d7fa8865b8dab42733))
* **js:** bump RTVI_PROTOCOL_VERSION to 1.3.0 for UI Agent Protocol ([98f3e7b](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/98f3e7bb29729dd16af21b75b872cf7c910f2529))
* **js:** capture text selection and promote &lt;p&gt; to a refed paragraph ([94fb746](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/94fb74621f0c55ff92a4fec6ce4a6c0f190e1c1d))
* **js:** disconnect the client when the bot disconnects, but give the option to stay connected ([2f6fbdb](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/2f6fbdbdd44e01faa80f11d70c93e73b41cf3ad7))
* **js:** expose findRefForElement on a11y walker for element-to-ref lookup ([47c6d6d](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/47c6d6d78c491f73f63f665de254342e889e5af4))
* **js:** new callback for handling unsupported features ([3f38460](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/3f384604a1c3e5d38ba991319df6406a3b044850))
* **js:** rename UI agent -&gt; worker; UIAgent -&gt; UIWorker ([4a232a0](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/4a232a0ae95e30d9f9917fb4b82e4aafa346eb56))
* **js:** rename UI task protocol to job-group ([de1f3b3](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/de1f3b336b09e7f7ebc9e7d7dbb6def9c72c1426))
* **js:** walker uses option text for select values and emits options as children ([a9a08d0](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/a9a08d09b5383a51acc97b1c02bb19c2b68ad2b0))
...
* **client-js:** align ErrorData with server payload ([6d4907f](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/6d4907f8c0a49808504e2d87ff509618ded19385))
* **client-js:** align ErrorData with server payload ([8495644](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/8495644981b8d026628c8a3fe89bfb9c5c9ac523))
* **client-js:** only warn on deprecated onBotTranscript when subscribed ([c4c7390](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/c4c7390407548951645029744e04d634390bfe2b))
* **js:** bump uuid to ^11.1.1 to patch GHSA-w5hq-g745-h8pq ([c4f9108](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/c4f9108c43cd0fbf0260f93007360f0305ce8881))
* **js:** only warn on deprecated onBotTranscript when subscribed ([0df6ffc](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/0df6ffcfbd8826ea640269a212f43b794e244151))
* **js:** refresh snapshot when native form controls change ([56fa3c5](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/56fa3c531be29d085f5585f622b2eb2cb7d56097))
* **js:** refresh snapshot when native form controls change ([f09e1be](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/f09e1beb4729c1a581623a0e88650aa19251e5de))
* **js:** resolve open Dependabot dependency vulnerabilities ([61ae50c](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/61ae50cdcf5de459d7de99ba609ad9388652e0bb))
...
* **js:** force release 1.12.0 for RTVI protocol 2.0.0 ([#215](https://github.com/Nagadath-Gummadi/pipecat-client-web/issues/215)) ([#229](https://github.com/Nagadath-Gummadi/pipecat-client-web/issues/229)) ([b966fe3](https://github.com/Nagadath-Gummadi/pipecat-client-web/commit/b966fe385b65938265e3410fd8d04f4cd10f5d36))
